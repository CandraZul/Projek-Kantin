    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="bg-brown rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 200px;">
                        <div class="d-flex align-items-center justify-content-center" style="background-color: #1D2A4D; width: 100px; height: 100px; border-radius: 50%; transform: rotate(-15deg);">
                            <i class="fa fa-2x fa-location-arrow text-white" style="transform: rotate(15deg);"></i>
                        </div>
                        <h6 class="mb-0 text-white">123 Street, Surakarta, Indonesia</h6>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="bg-brown rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 200px;">
                        ...
                        <h6 class="mb-0 text-white">(414) 857 - 0107</h6>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="bg-brown rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 200px;">
                        ...
                        <h6 class="mb-0 text-white">yummy@bistrobliss</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12" style="height: 500px;">
                    <div class="position-relative h-100">
                        ...
                        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d1977.5742847656845!2d110.77358245267953!3d-7.558774999449463!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwMzMnMzEuNiJTIDExMMKwNDYnMjcuNCJF!5e0!3m2!1sen!2sid!4v1734841182975!5m2!1sen!2sid"></iframe>
